...
$classes = ($active ?? false)
            ? 'inline-flex items-center px-1 pt-1 border-b-2 border-red-800 text-sm font-medium leading-5 text-gray-900 focus:outline-none focus:border-red-700 transition'
